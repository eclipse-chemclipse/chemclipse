...
public class QuantitationCalculatorMSD_TIC_3_Test extends QuantitationCalculator_TIC_TestCase {
	...
	public void testCalculateConcentration12() {
		...
		assertEquals(0.029999999999999995d, quantitationEntry1.getConcentration(), 0);
	}
	...
	public void testCalculateConcentration22() {
		...
		assertEquals(0.03d, quantitationEntry2.getConcentration(), 0);
	}
