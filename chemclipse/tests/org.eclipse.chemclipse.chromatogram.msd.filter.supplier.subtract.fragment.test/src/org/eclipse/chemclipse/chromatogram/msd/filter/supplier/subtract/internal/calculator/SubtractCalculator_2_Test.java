...
public class SubtractCalculator_2_Test {
	...
	public void testMassSpectrumMap_2() {
		...
		assertEquals(20.0f, subtractMassSpectrumMap.get(18.0), 0);
	}

	@Test
	public void testMassSpectrumMap_3() {

		assertEquals(100.0f, subtractMassSpectrumMap.get(28.0), 0);
	}

	@Test
	public void testMassSpectrumMap_4() {

		assertEquals(50.0f, subtractMassSpectrumMap.get(32.0), 0);
	}
	...
	public void testSubtractedMassSpectrum_3() {
		...
		assertEquals(6787.44f, targetMassSpectrum.getIon(18.1).getAbundance(), 0);
	}
	...
	public void testSubtractedMassSpectrum_5() {
		...
		assertEquals(1947.3f, targetMassSpectrum.getIon(32.0).getAbundance(), 0);
	}
