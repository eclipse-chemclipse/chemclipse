...
public class SubtractCalculator_4_Test {
	...
	public void testMassSpectrumMap_2() {
		...
		assertEquals(20.0f, subtractMassSpectrumMap.get(18.2), 0);
	}

	@Test
	public void testMassSpectrumMap_3() {

		assertEquals(100.0f, subtractMassSpectrumMap.get(28.1), 0);
	}

	@Test
	public void testMassSpectrumMap_4() {

		assertEquals(50.0f, subtractMassSpectrumMap.get(32.3), 0);
	}
	...
	public void testSubtractedMassSpectrum_5() {
		...
		assertEquals(1947.3f, targetMassSpectrum.getIon(32.3).getAbundance(), 0);
	}
