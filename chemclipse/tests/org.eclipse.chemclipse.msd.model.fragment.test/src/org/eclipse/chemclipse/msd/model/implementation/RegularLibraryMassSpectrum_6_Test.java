...
public class RegularLibraryMassSpectrum_6_Test {
	...
	public void test2() {
		...
		assertEquals(687.3603d, massSpectrum.getPrecursorIon(), 0);
	}

	@Test
	public void test3() {

		assertEquals(688.3682407538258d, massSpectrum.getNeutralMass(), 0);
	}
