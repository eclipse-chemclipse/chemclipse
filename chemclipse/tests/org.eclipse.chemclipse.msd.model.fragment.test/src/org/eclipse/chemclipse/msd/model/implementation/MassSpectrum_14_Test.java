 ...
 */
public class MassSpectrum_14_Test {
	...
	public void setUp() {
		...
		massSpectrum.addIon(ion);
		massSpectrum.normalize();
	}

	@Test
	public void testGetNormalizationBase_1() {

		assertEquals("normalizationBase", 100.0f, massSpectrum.getNormalizationBase(), 0);
	}
	...
	public void testGetTotalSignal_1() {
		...
		assertEquals("getTotalSignal", 139.471472f, massSpectrum.getTotalSignal(), 0);
	}
	...
	public void testGetExtractedIonSignal_2() {
		...
		assertEquals("getExtractedIonSignal", 13.475312f, massSpectrum.getExtractedIonSignal(25, 120).getAbundance(104), 0);
	}

	@Test
	public void testGetExtractedIonSignal_3() {

		assertEquals("getExtractedIonSignal", 100.0f, massSpectrum.getExtractedIonSignal(25, 120).getAbundance(33), 0);
	}

	@Test
	public void testGetExtractedIonSignal_4() {

		assertEquals("getExtractedIonSignal", 13.475312f, massSpectrum.getExtractedIonSignal(25, 120).getAbundance(106), 0);
	}
	...
	public void testGetBasePeakAbundance_1() {
		...
		assertEquals("getBasePeakAbundance", 100.0f, massSpectrum.getBasePeakAbundance(), 0);
	}

	@Test
	public void testGetHighestAbundance_1() {

		assertEquals("getHighestAbundance", 100.0f, massSpectrum.getHighestAbundance().getAbundance(), 0);
	}
	...
	public void testGetHighestIon_1() {
		...
		assertEquals("getHighestIon", 13.475312f, massSpectrum.getHighestIon().getAbundance(), 0);
	}
	...
	public void testGetLowestAbundance_1() {
		...
		assertEquals("getLowestAbundance", 3.7057545f, massSpectrum.getLowestAbundance().getAbundance(), 0);
	}
	...
	public void testGetLowestIon_1() {
		...
		assertEquals("getLowestIon", 3.7057545f, massSpectrum.getLowestIon().getAbundance(), 0);
	}
	...
	public void testGetIonBounds_1() {
		...
		assertEquals("getLowestIon().getAbundance()", 3.7057545f, bounds.getLowestIon().getAbundance(), 0);
		assertEquals("getLowestIon().getIon()", 28.200000762939453d, bounds.getLowestIon().getIon(), 0);
		assertEquals("getHighestIon().getAbundance()", 13.475312f, bounds.getHighestIon().getAbundance(), 0);
	...
	public void testGetIon_1() {
		...
		assertEquals("getIon(46) abundance", 8.815093f, ion.getAbundance(), 0);
