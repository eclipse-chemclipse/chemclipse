...
public class CombinedMassSpectrum_1_Test {
	...
	public void testStartRetentionIndex_1() {
		...
		assertEquals("Start RI", 0.0f, massSpectrum.getStartRetentionIndex(), 0);
	}
	...
	public void testStartRetentionIndex_3() {
		...
		assertEquals("Start RI", 745.2f, massSpectrum.getStartRetentionIndex(), 0);
	}
	...
	public void testStopRetentionIndex_1() {
		...
		assertEquals("Stop RI", 0.0f, massSpectrum.getStopRetentionIndex(), 0);
	}
	...
	public void testStopRetentionIndex_3() {
		...
		assertEquals("Stop RI", 4050.3f, massSpectrum.getStopRetentionIndex(), 0);
	}
