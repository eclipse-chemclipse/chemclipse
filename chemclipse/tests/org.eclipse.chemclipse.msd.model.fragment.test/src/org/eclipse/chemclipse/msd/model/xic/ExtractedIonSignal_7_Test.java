...
public class ExtractedIonSignal_7_Test {
	...
	public void testSize_1() {
		...
		assertEquals(742.14f, extractedIonSignal.getMeanIntensity(), 0);
	}
	...
	public void testSize_2() {
		...
		assertEquals(1128.3958f, extractedIonSignal.getMeanIntensity(), 0);
	}
	...
	public void testSize_3() {
		...
		assertEquals(0.0f, extractedIonSignal.getMeanIntensity(), 0);
	}
}
