...
public class TotalIonSignals_7_Test {
	...
	public void testSize_1() {
		...
		List<ITotalScanSignal> signals2 = signals.getTotalScanSignals();
		assertEquals("size2", 12, signals2.size());
		signals2.clear();
		assertEquals("size", 12, signals.size());
		assertEquals("size2", 0, signals2.size());
	}
}
