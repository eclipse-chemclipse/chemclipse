...
public class MassSpectrum_9_Test {
	...
	public void getTotalSignal_1() {
		...
		assertEquals("getTotalSignal", 213201.69f, massSpectrum.getTotalSignal(), 0);
	}
	...
	public void getExtractedIonSignal_4() {
		...
		assertEquals("getExtractedIonSignal", 90200.8f, massSpectrum.getExtractedIonSignal(40, 120).getAbundance(46), 0);
	}
	...
	public void testGetLowestIon_1() {
		...
		assertEquals("getLowestIon", 90200.8f, massSpectrum.getLowestIon().getAbundance(), 0);
	}
	...
	public void testGetIonBounds_1() {
		...
		assertEquals("getLowestIon().getAbundance()", 90200.8f, bounds.getLowestIon().getAbundance(), 0);
	...
	public void testGetIon_1() {
		...
		assertEquals("getIon(46) abundance", 90200.8f, ion.getAbundance(), 0);
