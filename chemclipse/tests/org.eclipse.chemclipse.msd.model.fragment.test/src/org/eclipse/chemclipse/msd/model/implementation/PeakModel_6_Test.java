...
public class PeakModel_6_Test extends PeakModelTestCase {
	...
	public void testGetBackgroundAbundance_1() {
		...
		assertEquals(1000.0f, peakModel.getBackgroundAbundance(1500), 0);
	}

	@Test
	public void testGetBackgroundAbundance_2() {

		assertEquals(1000.0f, peakModel.getBackgroundAbundance(7800), 0);
	}

	@Test
	public void testGetBackgroundAbundance_3() {

		assertEquals(1000.0f, peakModel.getBackgroundAbundance(15500), 0);
	}

	@Test
	public void testGetBackgroundAbundance_4() {

		assertEquals(1000.0f, peakModel.getBackgroundAbundance(), 0);
	}
