...
public class PeakBuilder_13_Test extends PeakBuilderExtendedTestCase {
	...
	public void setUp() throws Exception {
		 ...
		 */
		peakMassSpectrum.adjustTotalSignal(5085.51f); // 5231.0f - 145.48741f
														// (background at
														// retention time x =
														// 9500).
		peak = PeakBuilderMSD.createPeak(chromatogram, totalIonSignals, peakMassSpectrum);
	}
	...
	public void testGetBackgroundAbundanceAtScan_1() {
		...
		assertEquals("background", 145.48741f, background, 0);
	}
	...
	public void testGetPeakAbundanceAtScan_2() {
		...
		assertEquals("abundance", 5085.5103f, abundance, 0);
	}
	...
	public void testGetPeakAbundanceAtScan_3() {
		...
		assertEquals("abundance", 762.82654f, abundance, 0);
	}
	...
	public void testGetPeakAbundanceAtScan_4() {
		...
		assertEquals("abundance", 1525.653f, abundance, 0);
	}
