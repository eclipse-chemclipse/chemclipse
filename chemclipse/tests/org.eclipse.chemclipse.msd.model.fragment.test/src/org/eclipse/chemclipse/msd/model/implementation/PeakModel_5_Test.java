...
public class PeakModel_5_Test extends PeakModelTestCase {

	protected float startBackgroundAbundance = 100000.0f;
	protected float stopBackgroundAbundance = 360.0f;
	...
	public void testGetBackgroundAbundance_1() {
		...
		assertEquals("GetBackgroundAbundance", 100000.0f, peakModel.getBackgroundAbundance(1500), 0);
	}

	@Test
	public void testGetBackgroundAbundance_2() {

		assertEquals("GetBackgroundAbundance", 55162.0f, peakModel.getBackgroundAbundance(7800), 0);
	}

	@Test
	public void testGetBackgroundAbundance_3() {

		assertEquals("GetBackgroundAbundance", 360.0f, peakModel.getBackgroundAbundance(15500), 0);
	}

	@Test
	public void testGetBackgroundAbundance_4() {

		assertEquals("GetBackgroundAbundance", 43062.855f, peakModel.getBackgroundAbundance(), 0);
	}
