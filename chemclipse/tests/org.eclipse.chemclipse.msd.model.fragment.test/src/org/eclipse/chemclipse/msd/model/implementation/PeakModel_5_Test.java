...
public class PeakModel_5_Test extends PeakModelTestCase {
	...
	public void testGetBackgroundAbundance_1() {
		...
		assertEquals(100000.0f, peakModel.getBackgroundAbundance(1500), 0);
	}

	@Test
	public void testGetBackgroundAbundance_2() {

		assertEquals(55162.0f, peakModel.getBackgroundAbundance(7800), 0);
	}

	@Test
	public void testGetBackgroundAbundance_3() {

		assertEquals(360.0f, peakModel.getBackgroundAbundance(15500), 0);
	}

	@Test
	public void testGetBackgroundAbundance_4() {

		assertEquals(43062.855f, peakModel.getBackgroundAbundance(), 0);
	}
