...
/*
 * PreserveTandemMS - true
 */
public class NominalizeScanFilter_1b_Test {
	...
	public void setUp() {
		...
		massSpectrum.addIon(new Ion(100.0, 1000f));
		massSpectrum.addIon(new Ion(200.0, 2000f));
		massSpectrum.addIon(new Ion(300.0, 3000f));
	...
	public void test02() {
		...
		assertEquals(3, massSpectra.get(0).getIons().size());
	}
	...
	public void test04() {
		...
		filter.applyFilter(massSpectra, settings, new NullProgressMonitor());
		List<IIon> ions = sortedIons(massSpectra.get(0));
		assertEquals(200.0, ions.get(1).getIon(), 0.001);
	}
	...
	public void test05() {
		...
		filter.applyFilter(massSpectra, settings, new NullProgressMonitor());
		List<IIon> ions = sortedIons(massSpectra.get(0));
		assertEquals(300.0, ions.get(2).getIon(), 0.001);
	}
	...
	public void test06() {
		...
		filter.applyFilter(massSpectra, settings, new NullProgressMonitor());
		List<IIon> ions = sortedIons(massSpectra.get(0));
		assertEquals(1000f, ions.get(0).getAbundance(), 0.001);
	}
