...
public class UnitConverter_3_Test {
	...
	public void setUp() {
		...
		converter = ConverterFactory.getInstance(Unit.MM);
	}

	@Test
	public void test1a() {

		assertEquals(-2.83465f, converter.convertToPt(-1.0f), 0);
	}

	@Test
	public void test1b() {

		assertEquals(-1.0f, converter.convertFromPt(-2.83465f), 0);
	}
