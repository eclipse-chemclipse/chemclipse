...
public class ChromatogramReader_2_MSD_0903_ITest extends ChromatogramReaderMSDTestCase {
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram2-0903", chromatogram.getName());
	}
	...
	public void testReader_8() {
		...
		assertEquals(3.2942506E7f, chromatogram.getMaxSignal(), 0); // see Note on top
	}

	@Test
	public void testReader_9() {

		assertEquals(190480.0f, chromatogram.getMinSignal(), 0); // see Note on top
	}
