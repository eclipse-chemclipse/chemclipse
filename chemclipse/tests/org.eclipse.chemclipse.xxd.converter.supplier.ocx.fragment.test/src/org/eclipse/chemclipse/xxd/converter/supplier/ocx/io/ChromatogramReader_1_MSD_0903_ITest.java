...
public class ChromatogramReader_1_MSD_0903_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File(TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_0903));
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-0903", chromatogram.getName());
	}
