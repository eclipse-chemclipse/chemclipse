...
public class ChromatogramReader_1_MSD_1001_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File(TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_1001));
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-1001", chromatogram.getName());
	}
