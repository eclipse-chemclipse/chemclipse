...
public class ChromatogramReader_1_FID_1501_ITest extends ChromatogramReaderFIDTestCase {
	...
	public void setUp() throws Exception {
		...
		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_1501);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-1501-fromMSD", chromatogram.getName());
	}
