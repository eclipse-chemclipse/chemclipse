...
public class ChromatogramReader_1_FID_1004_ITest extends ChromatogramReaderFIDTestCase {
	...
	public void setUp() throws Exception {
		...
		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_1004);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-1004-fromMSD", chromatogram.getName());
	}
