...
public class ChromatogramReader_1_FID_1003_ITest extends ChromatogramReaderFIDTestCase {
	...
	public void setUp() throws Exception {
		...
		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_1003);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-1003-fromMSD", chromatogram.getName());
	}
