...
public class ChromatogramReader_2_MSD_1301_ITest extends ChromatogramReaderMSDTestCase {

	@Override
	protected void setUp() throws Exception {

		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_2_MSD_1301);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram2-1301", chromatogram.getName());
	}
