...
public class ChromatogramReader_1_MSD_1006_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File(TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_1006));
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-1006", chromatogram.getName());
	}
