...
public class ChromatogramReader_1_FID_1007_ITest extends ChromatogramReaderFIDTestCase {
	...
	public void setUp() throws Exception {
		...
		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_1007);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-1007-fromMSD", chromatogram.getName());
	}
