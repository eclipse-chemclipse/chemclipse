...
public class ChromatogramReader_3_MSD_1100_ITest extends ChromatogramReaderMSDTestCase {

	@Override
	protected void setUp() throws Exception {

		PreferenceSupplier.setForceLoadAlternateDetector(true);
		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_3_FID_1100);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram3-1100-fromFID", chromatogram.getName());
	}
