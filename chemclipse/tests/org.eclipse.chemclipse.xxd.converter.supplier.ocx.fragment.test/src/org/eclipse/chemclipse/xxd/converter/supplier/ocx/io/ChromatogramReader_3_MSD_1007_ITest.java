...
public class ChromatogramReader_3_MSD_1007_ITest extends ChromatogramReaderMSDTestCase {

	@Override
	protected void setUp() throws Exception {

		PreferenceSupplier.setForceLoadAlternateDetector(true);
		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_3_FID_1007);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram3-1007-fromFID", chromatogram.getName());
	}
