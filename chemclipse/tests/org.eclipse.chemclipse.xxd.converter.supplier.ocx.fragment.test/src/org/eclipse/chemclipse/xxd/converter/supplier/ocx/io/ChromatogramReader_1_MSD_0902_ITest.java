...
public class ChromatogramReader_1_MSD_0902_ITest extends ChromatogramReaderMSDTestCase {

	@Override
	protected void setUp() throws Exception {

		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_1_MSD_0902);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram1-0902", chromatogram.getName());
	}
