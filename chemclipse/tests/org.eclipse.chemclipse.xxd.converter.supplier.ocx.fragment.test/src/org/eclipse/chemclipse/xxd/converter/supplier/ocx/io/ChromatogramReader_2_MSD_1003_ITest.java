...
public class ChromatogramReader_2_MSD_1003_ITest extends ChromatogramReaderMSDTestCase {

	@Override
	protected void setUp() throws Exception {

		pathImport = TestPathHelper.getAbsolutePath(TestPathHelper.TESTFILE_IMPORT_CHROMATOGRAM_2_MSD_1003);
		super.setUp();
	}
	...
	public void testReader_2() {
		...
		assertEquals("Chromatogram2-1003", chromatogram.getName());
	}
	...
	public void testChromatogramReader_12() {
		...
		assertEquals(309421.0f, massSpectrum.getTotalSignal());
		/*
		 * Import complete
		 */
	...
	public void testChromatogramReader_13() {
		...
		assertEquals(641153.0f, massSpectrum.getTotalSignal());
		/*
		 * Import complete
		 */
		massSpectrum.enforceLoadScanProxy();
	...
	public void testChromatogramReader_14() {
		...
		assertEquals(409367.0f, massSpectrum.getTotalSignal());
		/*
		 * Import complete
		 */
		massSpectrum.enforceLoadScanProxy();
	...
	public void testChromatogramReader_15() {
		...
		assertEquals(527807.0f, massSpectrum.getTotalSignal());
		/*
		 * Import complete
		 */
		massSpectrum.enforceLoadScanProxy();
