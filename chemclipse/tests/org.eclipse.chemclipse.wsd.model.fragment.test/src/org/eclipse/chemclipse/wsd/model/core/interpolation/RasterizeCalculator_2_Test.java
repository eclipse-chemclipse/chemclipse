...
public class RasterizeCalculator_2_Test {
	...
	public void test2() {
		...
		assertEquals(500.0f, dataRasterized.get(200), 0);
		assertEquals(750.0f, dataRasterized.get(201), 0);
		assertEquals(1000.0f, dataRasterized.get(202), 0);
		assertEquals(1250.0f, dataRasterized.get(203), 0);
		assertEquals(1500.0f, dataRasterized.get(204), 0);
		assertEquals(1250.0f, dataRasterized.get(205), 0);
		assertEquals(1000.0f, dataRasterized.get(206), 0);
		assertEquals(900.0f, dataRasterized.get(207), 0);
		assertEquals(800.0f, dataRasterized.get(208), 0);
		assertEquals(700.0f, dataRasterized.get(209), 0);
		assertEquals(600.0f, dataRasterized.get(210), 0);
	}
