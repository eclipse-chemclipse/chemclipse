...
public class RasterizeCalculator_5_Test {
	...
	public void test2() {
		...
		assertEquals(-250.0f, dataRasterized.get(201), 0);
		assertEquals(0.0f, dataRasterized.get(202), 0);
		assertEquals(250.0f, dataRasterized.get(203), 0);
		assertEquals(500.0f, dataRasterized.get(204), 0);
		assertEquals(750.0f, dataRasterized.get(205), 0);
		assertEquals(1000.0f, dataRasterized.get(206), 0);
		assertEquals(750.0f, dataRasterized.get(207), 0);
		assertEquals(500.0f, dataRasterized.get(208), 0);
		assertEquals(50.0f, dataRasterized.get(209), 0);
		assertEquals(-400.0f, dataRasterized.get(210), 0);
	}
