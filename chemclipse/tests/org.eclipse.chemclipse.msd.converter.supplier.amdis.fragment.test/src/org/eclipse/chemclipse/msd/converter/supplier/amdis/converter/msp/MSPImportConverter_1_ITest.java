...
public class MSPImportConverter_1_ITest {
	...
	public void test_2() {
		...
		assertEquals(1.46215e-01f, massSpectrum.getIon(20).getAbundance(), 0);
		assertEquals(3.00030e-03f, massSpectrum.getIon(36).getAbundance(), 0);
		assertEquals(5.00050e-04f, massSpectrum.getIon(38).getAbundance(), 0);
		assertEquals(1.00000e+00f, massSpectrum.getIon(40).getAbundance(), 0);
	}
	...
	public void test_3() {
		...
		assertEquals(1.37914e-01f, massSpectrum.getIon(14).getAbundance(), 0);
		assertEquals(1.00000e+00f, massSpectrum.getIon(28).getAbundance(), 0);
		assertEquals(7.40074e-03f, massSpectrum.getIon(29).getAbundance(), 0);
	}
	...
	public void test_4() {
		...
		assertEquals(2.18022e-01f, massSpectrum.getIon(16).getAbundance(), 0);
		assertEquals(1.00000e+00f, massSpectrum.getIon(32).getAbundance(), 0);
	}
