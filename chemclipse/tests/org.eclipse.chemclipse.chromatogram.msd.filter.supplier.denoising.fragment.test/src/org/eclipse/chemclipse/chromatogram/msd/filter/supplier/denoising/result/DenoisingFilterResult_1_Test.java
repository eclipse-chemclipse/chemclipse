...
public class DenoisingFilterResult_1_Test extends TestCase {

	private IDenoisingFilterResult result = new DenoisingFilterResult(ResultStatus.OK, "The result status is ok.");
