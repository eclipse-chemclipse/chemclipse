...
public class IonRoundMethod_MINUS_01_1_Test {

	private IonRoundMethod ionRoundMethod = IonRoundMethod.MINUS_01;
	...
	public void test5() {
		...
		assertEquals(17, ionRoundMethod.round(17.8d));
	}
	...
	public void test8() {
		...
		assertEquals(18, ionRoundMethod.round(18.8d));
	}

	@Test
	public void test9() {

		assertEquals(19, ionRoundMethod.round(18.9d));
	}

	@Test
	public void test10() {

		assertEquals("Round m/z from -0.1 (incl.) to +0.9 (excl.)", ionRoundMethod.label());
	}
}