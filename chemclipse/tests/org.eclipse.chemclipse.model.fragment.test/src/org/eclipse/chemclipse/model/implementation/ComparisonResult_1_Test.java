...
public class ComparisonResult_1_Test {
	...
	public void test1() {
		...
		assertEquals(DEFAULT_VALUE, comparisonResult.getMatchFactor(), 0);
	}

	@Test
	public void test2() {

		assertEquals(DEFAULT_VALUE, comparisonResult.getReverseMatchFactor(), 0);
	}

	@Test
	public void test3() {

		assertEquals(DEFAULT_VALUE, comparisonResult.getMatchFactorDirect(), 0);
	}

	@Test
	public void test4() {

		assertEquals(DEFAULT_VALUE, comparisonResult.getReverseMatchFactorDirect(), 0);
	}
