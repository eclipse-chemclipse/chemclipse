...
public class IonRoundMethod_MINUS_07_1_Test {

	private IonRoundMethod ionRoundMethod = IonRoundMethod.MINUS_07;
	...
	public void test5() {
		...
		assertEquals(17, ionRoundMethod.round(17.2d));
	}
	...
	public void test8() {
		...
		assertEquals(18, ionRoundMethod.round(18.2d));
	}

	@Test
	public void test9() {

		assertEquals(19, ionRoundMethod.round(18.3d));
	}

	@Test
	public void test10() {

		assertEquals("Round m/z from -0.7 (incl.) to +0.3 (excl.)", ionRoundMethod.label());
	}
}