...
public class IonRoundMethod_MINUS_05_1_Test {

	private IonRoundMethod ionRoundMethod = IonRoundMethod.MINUS_05;
	...
	public void test5() {
		...
		assertEquals(17, ionRoundMethod.round(17.4d));
	}
	...
	public void test8() {
		...
		assertEquals(18, ionRoundMethod.round(18.4d));
	}

	@Test
	public void test9() {

		assertEquals(19, ionRoundMethod.round(18.5d));
	}

	@Test
	public void test10() {

		assertEquals("Round m/z from -0.5 (incl.) to +0.5 (excl.)", ionRoundMethod.label());
	}
}