...
public class ComparisonResult_2_Test {
	...
	public void test1() {
		...
		assertEquals(78.0f, comparisonResult.getMatchFactor(), 0);
	}

	@Test
	public void test2() {

		assertEquals(78.0f, comparisonResult.getReverseMatchFactor(), 0);
	}

	@Test
	public void test3() {

		assertEquals(78.0f, comparisonResult.getMatchFactorDirect(), 0);
	}

	@Test
	public void test4() {

		assertEquals(78.0f, comparisonResult.getReverseMatchFactorDirect(), 0);
	}
