...
public abstract class AbstractPeakIntegrator implements IPeakIntegrator {
	...
	protected IProcessingInfo<IPeakIntegrationResults> validate(IPeak peak, IPeakIntegrationSettings peakIntegrationSettings) {
	...
	protected IProcessingInfo<IPeakIntegrationResults> validate(List<? extends IPeak> peaks, IPeakIntegrationSettings peakIntegrationSettings) {
	...
	private void testPeakIntegrationSettings(IPeakIntegrationSettings peakIntegrationSettings, IProcessingInfo<IPeakIntegrationResults> processingInfo) {
