...
public class ChromatogramIntegratorProcessTypeSupplier implements IProcessTypeSupplier {
	...
	public String getCategory() {
		...
		return ICategories.CHROMATOGRAM_INTEGRATOR;
	}
	...
	private static final class ChromatogramIntegratorProcessorSupplier extends ChromatogramSelectionProcessorSupplier<IChromatogramIntegrationSettings> {
		...
		@Override
		public IChromatogramSelection apply(IChromatogramSelection chromatogramSelection, IChromatogramIntegrationSettings processSettings, IMessageConsumer messageConsumer, IProgressMonitor monitor) {
