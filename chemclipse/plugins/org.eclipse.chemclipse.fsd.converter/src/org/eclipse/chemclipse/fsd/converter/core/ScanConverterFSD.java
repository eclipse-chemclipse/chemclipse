...
public class ScanConverterFSD {

	private static final Logger logger = Logger.getLogger(ScanConverterFSD.class);
	private static final String EXTENSION_POINT = "org.eclipse.chemclipse.fsd.converter.scanSupplier";

	/**
	 * This class has only static methods.
	 */
	private ScanConverterFSD() {

	}

	public static IProcessingInfo<ISpectrumFSD> convert(final File file, final String converterId, final IProgressMonitor monitor) {
	...
	public static IProcessingInfo<ISpectrumFSD> convert(final File file, final IProgressMonitor monitor) {
	 ...
	 */
	private static IProcessingInfo<ISpectrumFSD> getScan(final File file, IProgressMonitor monitor) {
	...
	public static IProcessingInfo<File> convert(final File file, final ISpectrumFSD spectrum, final String converterId, final IProgressMonitor monitor) {
		...
		if(exportConverter != null) {
			processingInfo = exportConverter.convert(file, spectrum, monitor);
		}
		return processingInfo;
	}
	...
	public static IScanConverterSupport getScanConverterSupport() {
		...
		ScanConverterSupport converterSupport = new ScanConverterSupport(DataCategory.FSD);
		IExtensionRegistry registry = Platform.getExtensionRegistry();
