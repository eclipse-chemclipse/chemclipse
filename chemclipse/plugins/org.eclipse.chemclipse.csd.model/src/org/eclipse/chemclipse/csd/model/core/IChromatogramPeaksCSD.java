...
public interface IChromatogramPeaksCSD extends IChromatogramPeaks {
	 ...
	 */
	@Override
	List<IChromatogramPeakCSD> getPeaks(int startRetentionTime, int stopRetentionTime);
	 ...
	 */
	@Override
	default List<IChromatogramPeakCSD> getPeaks(IRetentionTimeRange range) {
