...
import org.eclipse.chemclipse.ux.extension.pcr.ui.swt.ExtendedWellDataUI;
...
public class WellDataPart extends AbstractPart<ExtendedWellDataUI> {

	private static final String TOPIC = IChemClipseEvents.TOPIC_WELL_PCR_UPDATE_SELECTION;

	@Inject
	public WellDataPart(Composite parent) {

		super(parent, TOPIC, Activator.getDefault().getDataUpdateSupport());
	}

	@Override
	protected ExtendedWellDataUI createControl(Composite parent) {

		return new ExtendedWellDataUI(parent, SWT.NONE);
	}
