	...
	private ComboViewer createChromatogramActionCombo(Composite parent) {
		...
		comboViewer.setLabelProvider(new AbstractLabelProvider() {
			...
			public String getText(Object element) {
				...
				if(element instanceof ChromatogramEditorActionExtension chromatogramEditorActionExtension) {
					return chromatogramEditorActionExtension.getLabel();
				}
				return null;
			}
		});
				...
				if(chromatogramSelection != null) {
					...
					if(extension != null) {
						...
						if(action != null) {
							...
							e.display.asyncExec(() -> chromatogramSelection.update(false));
						}
					} else {
