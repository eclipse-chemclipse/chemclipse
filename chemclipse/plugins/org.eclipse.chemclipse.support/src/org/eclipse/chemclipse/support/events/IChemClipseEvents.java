...
public interface IChemClipseEvents {
	...
	String TOPIC_PART_UPDATE = "part/update";
	...
	String TOPIC_PCA_UPDATE_HIGHLIGHT_LOADINGBAR_VARIABLE = "pca/update/highlight/loadingbar/variable";
	String TOPIC_PCA_UPDATE_HIGHLIGHT_LOADINGLIST_VARIABLE = "pca/update/highlight/loadinglist/variable";
