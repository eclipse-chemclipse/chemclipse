 ...
 */
public class ChromatogramWriter_1501 extends AbstractChromatogramWriter implements IChromatogramCSDZipWriter {
	...
	private void writeChromatogramScans(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramCSD chromatogram, IProgressMonitor monitor) throws IOException {
		...
		try {
			for(int scan = 1; scan <= scans; scan++) {
				 ...
				 */
				writer1501.writeIdentificationTargets(dataOutputStream, scanCSD.getTargets());
				//
				subMonitor.worked(1);
			}
		} finally {
