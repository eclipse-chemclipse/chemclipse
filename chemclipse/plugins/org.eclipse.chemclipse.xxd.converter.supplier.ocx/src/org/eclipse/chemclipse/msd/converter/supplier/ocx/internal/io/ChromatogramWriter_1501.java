 ...
 */
public class ChromatogramWriter_1501 extends AbstractChromatogramWriter implements IChromatogramMSDZipWriter {
	...
	private void writeVersion(ZipOutputStream zipOutputStream, String directoryPrefix) throws IOException {
		...
		String version = AbstractIO_1501.VERSION;
	...
	private void writeOverviewFolder(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramMSD chromatogram) throws IOException {
	...
	private void writeChromatogramIdentification(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramMSD chromatogram) throws IOException {
		...
		writer1501.writeIdentificationTargets(dataOutputStream, chromatogram.getTargets());
	...
	private void writeChromatogramMiscellaneous(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramMSD chromatogram) throws IOException {
		 ...
		 * Miscellaneous
		 */
		writer1501.writeTargetDisplaySettings(dataOutputStream, chromatogram);
	...
	private void writeNormalMassSpectrum(DataOutputStream dataOutputStream, IScanMSD massSpectrum) throws IOException {
		 ...
		 */
		writer1501.writeIdentificationTargets(dataOutputStream, massSpectrum.getTargets());
	}
	...
	private void writePeak(DataOutputStream dataOutputStream, IPeakMSD peak) throws IOException {
		 ...
		 * Identification Results
		 */
		writer1501.writeIdentificationTargets(dataOutputStream, peak.getTargets());
		/*
	...
	private void writeSeparationColumn(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramMSD chromatogram) throws IOException {
		...
		writer1501.writeSeparationColumn(dataOutputStream, separationColumnIndices.getSeparationColumn());
