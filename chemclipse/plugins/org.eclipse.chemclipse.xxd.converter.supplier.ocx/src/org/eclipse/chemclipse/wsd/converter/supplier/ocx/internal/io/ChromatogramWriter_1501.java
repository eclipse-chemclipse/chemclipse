...
public class ChromatogramWriter_1501 extends AbstractChromatogramWriter implements IChromatogramWSDZipWriter {
	...
	private void writeChromatogramScans(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramWSD chromatogram, IProgressMonitor monitor) throws IOException {
		...
		try {
			for(int scan = 1; scan <= scans; scan++) {
				 ...
				 */
				writer1501.writeIdentificationTargets(dataOutputStream, scanWSD.getTargets());
				//
				subMonitor.worked(1);
			}
		} finally {
