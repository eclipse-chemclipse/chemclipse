...
public class ChromatogramWriter_1007 extends AbstractChromatogramWriter implements IChromatogramWSDZipWriter {
	...
	private void writeChromatogramFolder(ZipOutputStream zipOutputStream, String directoryPrefix, IChromatogramWSD chromatogram, IProgressMonitor monitor) throws IOException {
		 ...
		 */
		zipEntry = new ZipEntry(directoryPrefix + Format.DIR_CHROMATOGRAM_WSD);
		zipOutputStream.putNextEntry(zipEntry);
		zipOutputStream.closeEntry();
		/*
		 * WRITE THE FILES
