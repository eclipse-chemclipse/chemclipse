...
public class PeakRetentionIndexExtractor extends AbstractClassifierDescriptionExtractor {
	...
	public Samples extractPeakData(Map<IDataInputEntry, List<IPeak>> peaks, int retentionIndexWindow, DescriptionOption descriptionOption, ValueOption valueOption) {
	...
	private Map<String, SortedMap<Integer, IPeak>> exctractPcaPeakMap(Map<String, List<IPeak>> peakMap, int retentionIndexWindow) {
