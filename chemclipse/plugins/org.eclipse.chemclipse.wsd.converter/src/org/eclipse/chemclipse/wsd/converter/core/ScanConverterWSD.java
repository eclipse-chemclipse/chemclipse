...
public class ScanConverterWSD {

	private static final Logger logger = Logger.getLogger(ScanConverterWSD.class);
	private static final String EXTENSION_POINT = "org.eclipse.chemclipse.wsd.converter.scanSupplier";

	/**
	 * This class has only static methods.
	 */
	private ScanConverterWSD() {
	...
	public static IProcessingInfo<ISpectrumWSD> convert(final File file, final IProgressMonitor monitor) {
	...
	public static IScanConverterSupport getScanConverterSupport() {
		...
		ScanConverterSupport converterSupport = new ScanConverterSupport(DataCategory.WSD);
		IExtensionRegistry registry = Platform.getExtensionRegistry();
